    ...
    return (
        ...
        <div className="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
            <div className="p-10 xs:p-0 mx-auto sm:w-full sm:min-w-xl sm:max-w-4xl">
                ...
                <h1 className="font-bold text-center text-2xl mb-6">User Registeration</h1>  
                ...
                <div className="p-5">
                    <Link href="/login"><a className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block">Login</a></Link>
                </div>
                </div>
            </div>
        </div>
